.class final Lcom/facebook/katana/provider/Fb4aDatabaseHelper$6;
...
.method protected b(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v1, "Creating local photo facebox table"

    invoke-static {v0, v1}, Lcom/facebook/common/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 158
    invoke-static {}, Lcom/facebook/katana/provider/LocalFaceboxProvider;->b()Ljava/lang/String;
    ...
    .line 159
    invoke-static {}, Lcom/facebook/katana/provider/LocalFaceboxProvider;->c()[Ljava/lang/String;
