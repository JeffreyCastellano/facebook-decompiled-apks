...
.field private final b:Lcom/facebook/user/UserSerialization;
...
.method constructor <init>(Lcom/facebook/orca/database/ThreadsDatabaseSupplier;Lcom/facebook/user/UserSerialization;Lcom/fasterxml/jackson/databind/ObjectMapper;)V
    .locals 0
    .parameter
    .parameter
    .parameter
    ...
    .line 41
    iput-object p2, p0, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->b:Lcom/facebook/user/UserSerialization;

    .line 42
    iput-object p3, p0, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->c:Lcom/fasterxml/jackson/databind/ObjectMapper;
...
.method a(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableList;
    ...
    .line 80
    iget-object v0, p0, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->c:Lcom/fasterxml/jackson/databind/ObjectMapper;
    ...
    .line 81
    iget-object v1, p0, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->b:Lcom/facebook/user/UserSerialization;

    invoke-virtual {v1, v0}, Lcom/facebook/user/UserSerialization;->a(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/facebook/user/PicCropInfo;
    ...
    .line 87
    iget-object v6, p0, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->b:Lcom/facebook/user/UserSerialization;

    invoke-virtual {v6, v0}, Lcom/facebook/user/UserSerialization;->f(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/facebook/user/LastActive;

    move-result-object v0

    .line 90
    :goto_3
    new-instance v6, Lcom/facebook/user/UserBuilder;

    invoke-direct {v6}, Lcom/facebook/user/UserBuilder;-><init>()V
    ...
    invoke-virtual {v6, v7, v10}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/User$Type;Ljava/lang/String;)Lcom/facebook/user/UserBuilder;

    move-result-object v6

    invoke-virtual {v6, v5}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/Name;)Lcom/facebook/user/UserBuilder;
    ...
    invoke-virtual {v5, v6}, Lcom/facebook/user/UserBuilder;->e(Ljava/lang/String;)Lcom/facebook/user/UserBuilder;
    ...
    invoke-virtual {v5, v6}, Lcom/facebook/user/UserBuilder;->d(Ljava/lang/String;)Lcom/facebook/user/UserBuilder;

    move-result-object v5

    invoke-virtual {v5, v1}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/PicCropInfo;)Lcom/facebook/user/UserBuilder;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/LastActive;)Lcom/facebook/user/UserBuilder;
