.class Lcom/facebook/orca/database/DbFetchThreadsHandler;
...
.field private final g:Lcom/facebook/orca/database/DbClock;
...
.method constructor <init>(Lcom/facebook/orca/database/ThreadsDatabaseSupplier;Lcom/facebook/orca/database/DbFetchThreadUsersHandler;Lcom/facebook/orca/database/DbThreadsPropertyUtil;Lcom/facebook/orca/database/DbParticipantsSerialization;Lcom/facebook/orca/database/DbDraftSerialization;Ljavax/inject/Provider;Lcom/facebook/orca/database/DbClock;)V
    ...
    .line 60
    iput-object p1, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a:Lcom/facebook/orca/database/ThreadsDatabaseSupplier;
    ...
    .line 65
    iput-object p6, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->f:Ljavax/inject/Provider;

    .line 66
    iput-object p7, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->g:Lcom/facebook/orca/database/DbClock;
...
.method private a(Lcom/facebook/orca/threads/FolderName;JI)Ljava/util/LinkedHashMap;
    ...
    .line 229
    invoke-direct {p0, v0}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->c(Ljava/util/LinkedHashMap;)V
...
.method private a()Ljava/util/Set;
    ...
    .line 244
    iget-object v0, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a:Lcom/facebook/orca/database/ThreadsDatabaseSupplier;
...
.method private a(Ljava/util/LinkedHashMap;)Ljava/util/Set;
    ...
    .line 166
    :cond_2
    invoke-virtual {v0}, Lcom/facebook/orca/threads/ThreadSummary;->B()Lcom/google/common/collect/ImmutableList;
...
.method private b(Lcom/facebook/orca/threads/FolderName;JI)Ljava/util/LinkedHashMap;
    ...
    .line 283
    invoke-direct {p0}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a()Ljava/util/Set;
    ...
    .line 287
    iget-object v0, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->f:Ljavax/inject/Provider;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/facebook/orca/database/ThreadSummariesIterator;->a(Lcom/facebook/orca/threads/FolderName;JLjava/util/Set;Ljava/lang/String;)V
    ...
    .line 292
    invoke-virtual {v1}, Lcom/facebook/orca/threads/ThreadSummaryBuilder;->a()Ljava/lang/String;
...
.method private b(Ljava/util/LinkedHashMap;)V
    ...
    invoke-static {v5, v2}, Lcom/facebook/orca/common/util/SqlQueryBuilder;->d(Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/orca/common/util/SqlQueryBuilder$Expression;
...
.method private c(Ljava/util/LinkedHashMap;)V
    ...
    .line 344
    new-array v0, v1, [Lcom/facebook/orca/common/util/SqlQueryBuilder$Expression;
    ...
    invoke-static {v2}, Lcom/facebook/orca/common/util/SqlQueryBuilder;->a(Ljava/lang/String;)Lcom/facebook/orca/common/util/SqlQueryBuilder$Expression;
...
.method a(Lcom/facebook/orca/server/FetchMoreThreadsParams;)Lcom/facebook/orca/server/FetchMoreThreadsResult;
    ...
    invoke-direct {p0, v3, v4}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a(Ljava/util/Collection;I)Lcom/google/common/collect/ImmutableList;
    ...
    .line 197
    invoke-direct {p0, v1}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a(Ljava/util/LinkedHashMap;)Ljava/util/Set;
...
.method a(Lcom/facebook/orca/server/FetchThreadListParams;)Lcom/facebook/orca/server/FetchThreadListResult;
    ...
    .line 74
    iget-object v2, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->c:Lcom/facebook/orca/database/DbThreadsPropertyUtil;
    ...
    invoke-virtual {v2, v5, v6, v7}, Lcom/facebook/orca/database/DbThreadsPropertyUtil;->a(Lcom/facebook/orca/common/util/TypedKey;J)J
    ...
    invoke-virtual {v2, v7, v8}, Lcom/facebook/orca/database/DbThreadsPropertyUtil;->a(Lcom/facebook/orca/common/util/TypedKey;Z)Z

    move-result v2

    .line 78
    iget-object v7, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->c:Lcom/facebook/orca/database/DbThreadsPropertyUtil;
    ...
    invoke-virtual {v7, v8, v9, v10}, Lcom/facebook/orca/database/DbThreadsPropertyUtil;->a(Lcom/facebook/orca/common/util/TypedKey;J)J
    ...
    invoke-direct {p0, v9, v10, v11, v12}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a(Lcom/facebook/orca/threads/FolderName;JI)Ljava/util/LinkedHashMap;

    move-result-object v9

    .line 101
    invoke-direct {p0, v9}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a(Ljava/util/LinkedHashMap;)Ljava/util/Set;
    ...
    invoke-virtual {v11, v10}, Lcom/facebook/orca/database/DbFetchThreadUsersHandler;->a(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableList;

    move-result-object v10

    .line 105
    invoke-static {v4}, Lcom/facebook/orca/database/DbFolders;->a(Lcom/facebook/orca/threads/FolderName;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v9}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->a(Ljava/util/Collection;I)Lcom/google/common/collect/ImmutableList;
    ...
    invoke-direct {v9, v1, v0}, Lcom/facebook/orca/threads/ThreadsCollection;-><init>(Lcom/google/common/collect/ImmutableList;Z)V
    ...
    invoke-direct {p0, v0}, Lcom/facebook/orca/database/DbFetchThreadsHandler;->b(Lcom/facebook/orca/threads/FolderName;)Lcom/facebook/orca/threads/FolderCounts;
    ...
    .line 119
    iget-object v12, p0, Lcom/facebook/orca/database/DbFetchThreadsHandler;->g:Lcom/facebook/orca/database/DbClock;
    ...
    invoke-virtual {v12, v0, v1}, Lcom/facebook/orca/database/DbClock;->a(J)V
    ...
    invoke-virtual {v0, v2}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(Lcom/facebook/orca/server/DataFreshnessResult;)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v4}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(Lcom/facebook/orca/threads/FolderName;)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v9}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(Lcom/facebook/orca/threads/ThreadsCollection;)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v10}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(Lcom/google/common/collect/ImmutableList;)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v11}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(Lcom/facebook/orca/threads/FolderCounts;)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v5, v6}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->a(J)Lcom/facebook/orca/server/FetchThreadListResultBuilder;

    move-result-object v0

    invoke-virtual {v0, v7, v8}, Lcom/facebook/orca/server/FetchThreadListResultBuilder;->b(J)Lcom/facebook/orca/server/FetchThreadListResultBuilder;
