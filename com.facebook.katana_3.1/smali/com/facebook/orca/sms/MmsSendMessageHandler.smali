...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/facebook/orca/sms/MmsSendMessageHandler;->b:Lcom/facebook/debug/log/WtfToken;
...
.method private a(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/facebook/orca/sms/MmsContentResolverHandler;->b(J)V
...
.method a(Lcom/facebook/messages/model/threads/Message;Ljava/util/Set;)Lcom/facebook/messages/model/threads/Message;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/facebook/orca/sms/MmsContentResolverHandler;->a(Lcom/facebook/messages/model/threads/Message;Ljava/util/Set;)J
    ...
    .line 65
    new-instance v4, Lcom/facebook/orca/sms/MmsSendMessageHandler$SendTransactionState;

    invoke-direct {v4, v9}, Lcom/facebook/orca/sms/MmsSendMessageHandler$SendTransactionState;-><init>(Lcom/facebook/orca/sms/MmsSendMessageHandler$1;)V

    .line 66
    new-instance v0, Lcom/facebook/orca/sms/MmsSendMessageHandler$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/facebook/orca/sms/MmsSendMessageHandler$1;-><init>(Lcom/facebook/orca/sms/MmsSendMessageHandler;JLcom/facebook/orca/sms/MmsSendMessageHandler$SendTransactionState;Ljava/util/concurrent/Semaphore;)V

    .line 78
    iget-object v1, p0, Lcom/facebook/orca/sms/MmsSendMessageHandler;->c:Landroid/content/Context;
    ...
    .line 82
    sget-object v0, Landroid_src/provider/Telephony$Mms$Outbox;->a:Landroid/net/Uri;
    ...
    iget-object v6, p0, Lcom/facebook/orca/sms/MmsSendMessageHandler;->c:Landroid/content/Context;
    ...
    .line 88
    invoke-direct {p0, v2, v3}, Lcom/facebook/orca/sms/MmsSendMessageHandler;->a(J)V
    ...
    .line 97
    sget-object v1, Lcom/facebook/orca/sms/MmsSendMessageHandler;->b:Lcom/facebook/debug/log/WtfToken;

    sget-object v2, Lcom/facebook/orca/sms/MmsSendMessageHandler;->a:Ljava/lang/Class;

    const-string v3, "Send message timed out"

    invoke-static {v1, v2, v3, v0}, Lcom/facebook/debug/log/BLog;->a(Lcom/facebook/debug/log/WtfToken;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 100
    :cond_1
    invoke-static {v4}, Lcom/facebook/orca/sms/MmsSendMessageHandler$SendTransactionState;->a(Lcom/facebook/orca/sms/MmsSendMessageHandler$SendTransactionState;)I
    ...
    .line 105
    :cond_2
    invoke-static {v2, v3}, Lcom/facebook/orca/threads/MessagingIdUtil;->c(J)Ljava/lang/String;
    ...
    invoke-virtual {v2, v8}, Lcom/facebook/messages/model/threads/MessageBuilder;->a(Z)Lcom/facebook/messages/model/threads/MessageBuilder;
    ...
    sget-object v3, Lcom/facebook/messages/model/threads/Message$ChannelSource;->MMS:Lcom/facebook/messages/model/threads/Message$ChannelSource;
    ...
    invoke-virtual {v2, v8}, Lcom/facebook/messages/model/threads/MessageBuilder;->a(I)Lcom/facebook/messages/model/threads/MessageBuilder;

    move-result-object v2

    invoke-virtual {v2, v1}, Lcom/facebook/messages/model/threads/MessageBuilder;->a(Ljava/lang/String;)Lcom/facebook/messages/model/threads/MessageBuilder;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/facebook/messages/model/threads/MessageBuilder;->b(Ljava/lang/String;)Lcom/facebook/messages/model/threads/MessageBuilder;

    move-result-object v0

    invoke-virtual {v0, v9}, Lcom/facebook/messages/model/threads/MessageBuilder;->a(Lcom/facebook/location/Coordinates;)Lcom/facebook/messages/model/threads/MessageBuilder;
