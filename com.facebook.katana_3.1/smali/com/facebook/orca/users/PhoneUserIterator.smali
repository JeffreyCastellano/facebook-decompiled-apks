...
.field private e:Lcom/facebook/user/UserBuilder;
...
.method public constructor <init>(Landroid/content/ContentResolver;Lcom/facebook/user/OrcaPhoneNumberUtil;)V
    .locals 0
    .parameter
    .parameter
    ...
    .line 81
    iput-object p2, p0, Lcom/facebook/orca/users/PhoneUserIterator;->c:Lcom/facebook/user/OrcaPhoneNumberUtil;
...
.method private b(Ljava/lang/String;I)Lcom/facebook/user/UserPhoneNumber;
    ...
    invoke-static {v0, v1}, Lcom/facebook/debug/tracer/Tracer;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/debug/tracer/Tracer;

    move-result-object v1

    .line 388
    iget-object v0, p0, Lcom/facebook/orca/users/PhoneUserIterator;->c:Lcom/facebook/user/OrcaPhoneNumberUtil;
    ...
    .line 390
    invoke-virtual {v2}, Lcom/facebook/user/OrcaPhoneNumberUtil$SmsAddress;->a()Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/facebook/user/OrcaPhoneNumberUtil;->a(Ljava/lang/String;I)Lcom/facebook/user/UserPhoneNumber;
...
.method public b()Ljava/util/Collection;
    ...
    invoke-static {v0, v2}, Lcom/facebook/debug/log/BLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_2
    :try_start_3
    sget-object v2, Lcom/facebook/orca/users/PhoneUserIterator;->a:Ljava/lang/String;
    ...
    sget-object v2, Lcom/facebook/user/User$Type;->ADDRESS_BOOK:Lcom/facebook/user/User$Type;
    ...
    invoke-direct {v0, v2, v3}, Lcom/facebook/user/UserKey;-><init>(Lcom/facebook/user/User$Type;Ljava/lang/String;)V
...
.method public e()Lcom/facebook/user/User;
    ...
    .line 290
    iget-object v8, p0, Lcom/facebook/orca/users/PhoneUserIterator;->d:Landroid/database/Cursor;
    ...
    invoke-static {v0, v2}, Lcom/facebook/debug/log/BLog;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 303
    iget-object v0, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;
    ...
    iput-object v0, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    .line 305
    iget-object v0, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    sget-object v5, Lcom/facebook/user/User$Type;->ADDRESS_BOOK:Lcom/facebook/user/User$Type;

    invoke-virtual {v0, v5, v4}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/User$Type;Ljava/lang/String;)Lcom/facebook/user/UserBuilder;

    move-object v0, v1

    .line 312
    :goto_1
    iget-object v4, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v4}, Lcom/facebook/user/UserBuilder;->k()Lcom/facebook/user/PicCropInfo;
    ...
    iget-object v5, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v5}, Lcom/facebook/user/UserBuilder;->b()Ljava/lang/String;
    ...
    .line 323
    sget-object v5, Lcom/facebook/orca/users/PhoneUserIterator;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v7}, Lcom/facebook/user/UserBuilder;->b()Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lcom/facebook/debug/log/BLog;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 324
    iget-object v5, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v5, v4}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/PicCropInfo;)Lcom/facebook/user/UserBuilder;
    ...
    .line 330
    iget-object v5, p0, Lcom/facebook/orca/users/PhoneUserIterator;->d:Landroid/database/Cursor;
    ...
    .line 335
    iget-object v2, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v2}, Lcom/facebook/user/UserBuilder;->h()Lcom/facebook/user/Name;
    ...
    invoke-virtual {v2, v6}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/Name;)Lcom/facebook/user/UserBuilder;
    ...
    invoke-virtual {v0}, Lcom/facebook/user/UserBuilder;->b()Ljava/lang/String;
    ...
    .line 308
    new-instance v5, Lcom/facebook/user/UserBuilder;

    invoke-direct {v5}, Lcom/facebook/user/UserBuilder;-><init>()V

    iput-object v5, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    .line 309
    iget-object v5, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    sget-object v6, Lcom/facebook/user/User$Type;->ADDRESS_BOOK:Lcom/facebook/user/User$Type;

    invoke-virtual {v5, v6, v4}, Lcom/facebook/user/UserBuilder;->a(Lcom/facebook/user/User$Type;Ljava/lang/String;)Lcom/facebook/user/UserBuilder;
    ...
    invoke-virtual {v2}, Lcom/facebook/user/UserBuilder;->c()Ljava/util/List;
    ...
    .line 353
    iget-object v6, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;

    invoke-virtual {v6, v2}, Lcom/facebook/user/UserBuilder;->a(Ljava/util/List;)Lcom/facebook/user/UserBuilder;
    ...
    .line 362
    invoke-direct {p0, v2, v4}, Lcom/facebook/orca/users/PhoneUserIterator;->b(Ljava/lang/String;I)Lcom/facebook/user/UserPhoneNumber;
    ...
    invoke-virtual {v2}, Lcom/facebook/user/UserBuilder;->d()Ljava/util/List;
    ...
    invoke-virtual {v5, v2}, Lcom/facebook/user/UserBuilder;->b(Ljava/util/List;)Lcom/facebook/user/UserBuilder;
    ...
    .line 380
    iput-object v1, p0, Lcom/facebook/orca/users/PhoneUserIterator;->e:Lcom/facebook/user/UserBuilder;
