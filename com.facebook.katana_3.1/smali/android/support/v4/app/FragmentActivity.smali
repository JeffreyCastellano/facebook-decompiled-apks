...
.field final d:Landroid/support/v4/app/FragmentContainer;
...
.field o:Landroid/support/v4/app/FragmentActivityHost;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->d:Landroid/support/v4/app/FragmentContainer;
...
.method private i()Landroid/support/v4/app/FragmentHost;
    .locals 1

    .prologue
    .line 916
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->o:Landroid/support/v4/app/FragmentActivityHost;

    if-nez v0, :cond_0

    .line 917
    new-instance v0, Landroid/support/v4/app/FragmentActivityHost;

    invoke-direct {v0, p0}, Landroid/support/v4/app/FragmentActivityHost;-><init>(Landroid/support/v4/app/FragmentActivity;)V

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->o:Landroid/support/v4/app/FragmentActivityHost;
...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/LoaderManagerImpl;
    ...
    .prologue
    .line 899
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;
    ...
    invoke-direct {p0}, Landroid/support/v4/app/FragmentActivity;->i()Landroid/support/v4/app/FragmentHost;

    move-result-object v1

    invoke-direct {v0, p1, v1, p2}, Landroid/support/v4/app/LoaderManagerImpl;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHost;Z)V

    .line 906
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/LoaderManagerImpl;->a(Landroid/support/v4/app/FragmentHost;)V
...
.method a(Z)V
    ...
    .line 781
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->p_()V
...
.method b(Landroid/support/v4/app/Fragment;)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/FragmentManagerImpl;->b(I)I
...
.method public c_()Landroid/support/v4/app/FragmentManager;
    .locals 1
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 678
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->n:Landroid/support/v4/app/LoaderManagerImpl;
...
.method public h()Landroid/support/v4/app/LoaderManager;
    .locals 3
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/LoaderManagerImpl;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->n:Landroid/support/v4/app/LoaderManagerImpl;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 168
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v4/app/FragmentActivity;->a(I)Landroid/support/v4/app/Fragment;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->d:Landroid/support/v4/app/FragmentContainer;

    invoke-virtual {v0, v2, v3, v1}, Landroid/support/v4/app/FragmentManagerImpl;->a(Landroid/support/v4/app/FragmentHost;Landroid/support/v4/app/FragmentContainer;Landroid/support/v4/app/Fragment;)V
    ...
    .line 216
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->e:Ljava/util/HashMap;

    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 316
    :cond_c
    invoke-virtual {v5, v1}, Landroid/support/v4/app/FragmentManagerImpl;->b(Landroid/support/v4/app/Fragment;)V
...
.method protected onPause()V
    ...
    .line 416
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->j_()V
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 504
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->n_()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->j()Ljava/util/ArrayList;
    ...
    .line 516
    iget-boolean v8, v7, Landroid/support/v4/app/LoaderManagerImpl;->g:Z
    ...
    .line 519
    :cond_1
    invoke-virtual {v7}, Landroid/support/v4/app/LoaderManagerImpl;->h()V

    .line 520
    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;

    iget-object v7, v7, Landroid/support/v4/app/LoaderManagerImpl;->d:Ljava/lang/String;
    ...
    .line 531
    iput-object v4, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->b:Ljava/lang/Object;

    .line 532
    iput-object v3, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->c:Ljava/util/HashMap;

    .line 533
    iput-object v5, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->d:Ljava/util/ArrayList;

    .line 534
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;

    iput-object v1, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->e:Ljava/util/HashMap;
...
.method protected onStart()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->n()V

    .line 567
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/FragmentManagerImpl;

    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->l()V

    .line 568
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/FragmentManagerImpl;

    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->h()Z
    ...
    .line 571
    iput-boolean v3, p0, Landroid/support/v4/app/FragmentActivity;->l:Z

    .line 572
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->n:Landroid/support/v4/app/LoaderManagerImpl;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->o()V
    ...
    .line 588
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->m:Ljava/util/HashMap;
    ...
    .line 592
    invoke-virtual {v2}, Landroid/support/v4/app/LoaderManagerImpl;->e()V

    .line 593
    invoke-virtual {v2}, Landroid/support/v4/app/LoaderManagerImpl;->g()V
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/LoaderManagerImpl;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->n:Landroid/support/v4/app/LoaderManagerImpl;
    ...
    iget-boolean v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->f:Z
